  ...
  return (
    <div>
      <div className='bg-cover bg-center w-full h-screen flex flex-col justify-start items-center  p-4'>
        <img className="w-14" src="https://download.logo.wine/logo/Uber/Uber-Logo.wine.png" alt="" />
        <div className='bg-white w-full flex flex-col bg-opacity-50 backdrop-blur-md p-4 rounded-lg text-center gap-4'>
          ...
          <p className='text-sm'>Don't have an account? <a href="/user-signup" className='text-blue-500'>Sign Up</a></p>
          ...
          <Link to="/captain-login" className='bg-blue-800 text-white text-lg p-3 rounded-lg'>Sing in as captain</Link>
